...
res = ReACTed(sys, initialState, [0., T], X0, Zonotope(zeros(Float64, n), zeros(Float64, n, 1)), dirs, sys.globalConstraints, δ⁻, δ⁺, ReachabilityAnalysis.Exponentiation.BaseExp, 5, 5; mustSemantics=false)
...
plotProjectedFlowpipeLazy(res, dirs, n, joinpath("results/", "SandboxDim2.png"))#; xlim=(108.0, 110.0), ylim=(2.0, 3.0)
